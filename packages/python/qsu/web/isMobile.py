...
_MOBILE_PATTERN_FULL = re.compile(
...
_MOBILE_PATTERN_PREFIX = re.compile(
...
def isMobile(userAgent: str) -> bool:
	return bool(_MOBILE_PATTERN_FULL.search(userAgent)) or bool(
		_MOBILE_PATTERN_PREFIX.search(userAgent[0:4])
	)
