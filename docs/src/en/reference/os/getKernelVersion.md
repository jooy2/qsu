...
<PlatformSupport :rows="[
	...
	{ os: 'android', note: 'The Linux kernel release the device was built with.' },
	{ os: 'ios', support: { js: 'no', dart: 'yes', python: 'no' }, note: { js: 'Neither the JavaScript nor the Python package runs on iOS.', dart: 'The Darwin kernel version, as on macOS.', python: 'Neither the JavaScript nor the Python package runs on iOS.' } }
]" />
