...
<ParamsTable :rows="[
	{ name: 'interval', type: 'number', default: '100', desc: '표본을 재는 시간이며 단위는 밀리초입니다. `0`을 주면 잴 시간이 없으므로 `0`이 나옵니다.' },
	{ name: 'decimals', type: 'number', default: '1', desc: '남길 소수점 자릿수입니다. `0`이면 정수로 돌려줍니다.' }
]" />
