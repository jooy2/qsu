import{_ as t,C as l,c as e,o as p,j as a,ag as h,a as i,G as k}from"./chunks/framework.DWHySUGW.js";const D=JSON.parse('{"title":"sortByObjectKey","description":"","frontmatter":{},"headers":[],"relativePath":"reference/array/sortByObjectKey.md","filePath":"en/reference/array/sortByObjectKey.md","lastUpdated":1743294079000}'),r={name:"reference/array/sortByObjectKey.md"},c={id:"sortbyobjectkey",tabindex:"-1"};function d(E,s,y,o,g,b){const n=l("Badge");return p(),e("div",null,[a("h1",c,[s[0]||(s[0]=i("sortByObjectKey ",-1)),k(n,{type:"tip",text:"JavaScript"}),s[1]||(s[1]=i()),s[2]||(s[2]=a("a",{class:"header-anchor",href:"#sortbyobjectkey","aria-label":'Permalink to "sortByObjectKey <Badge type="tip" text="JavaScript" />"'},"​",-1))]),s[3]||(s[3]=h(`<p>Sort array values by a specific key value in an array containing multiple objects. It does not affect the order or value of elements within an object.</p><p>If the <code>numerically</code> option is <code>true</code>, when sorting an array consisting of strings, it sorts first by the numbers contained in the strings, not by their names.</p><h2 id="parameters" tabindex="-1">Parameters <a class="header-anchor" href="#parameters" aria-label="Permalink to &quot;Parameters&quot;">​</a></h2><ul><li><code>array::any[]</code></li><li><code>key::string</code></li><li><code>descending::boolean</code></li><li><code>numerically::boolean</code></li></ul><h2 id="returns" tabindex="-1">Returns <a class="header-anchor" href="#returns" aria-label="Permalink to &quot;Returns&quot;">​</a></h2><blockquote><p>any[]</p></blockquote><h2 id="examples" tabindex="-1">Examples <a class="header-anchor" href="#examples" aria-label="Permalink to &quot;Examples&quot;">​</a></h2><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-ihilw" id="tab-i-cAKa9" checked><label data-title="JavaScript" for="tab-i-cAKa9">JavaScript</label></div><div class="blocks"><div class="language-javascript vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> obj</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> [</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">	}</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">]</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">*/</span></span></code></pre></div></div></div>`,8))])}const F=t(r,[["render",d]]);export{D as __pageData,F as default};
