...
<PlatformSupport :rows="[
	...
	{ os: 'android', languages: 'dart', note: 'The address of the active interface, which is the mobile network when Wi-Fi is off.' },
	{ os: 'ios', languages: 'dart', note: 'The address of the active interface, which is the mobile network when Wi-Fi is off.' }
]" />
