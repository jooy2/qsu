...
<PlatformSupport :rows="[
	...
	{ os: 'android', languages: 'dart', note: '`HOME`, which for an app is a directory inside its own sandbox.' },
	{ os: 'ios', languages: 'dart', note: '`HOME`, which is the app\'s own sandbox. It is not a directory a person browses.' }
]" />
