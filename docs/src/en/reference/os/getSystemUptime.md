...
<PlatformSupport :rows="[
	...
	{ os: 'ios', languages: 'dart', note: 'Apple counts the boot time APIs as requiring a declared reason, so an app that ships this has to say why in its privacy manifest.' }
]" />
