import{_ as h,C as i,o as k,c as e,ah as a,E as n,j as l,a as E}from"./chunks/framework.C2WMkNym.js";const D=JSON.parse('{"title":"sortByObjectKey","description":"","frontmatter":{},"headers":[],"relativePath":"ko/reference/array/sortByObjectKey.md","filePath":"ko/reference/array/sortByObjectKey.md","lastUpdated":1789883226000}'),r={name:"ko/reference/array/sortByObjectKey.md"};function d(y,s,c,g,F,o){const t=i("ParamsTable"),p=i("ReturnType");return k(),e("div",null,[s[0]||(s[0]=a('<h1 id="sortbyobjectkey" tabindex="-1">sortByObjectKey <a class="header-anchor" href="#sortbyobjectkey" aria-label="Permalink to &quot;sortByObjectKey&quot;">​</a></h1><p>여러 개체가 포함된 배열의 특정 키 값을 기준으로 배열 값을 정렬합니다. 개체 내의 요소의 순서나 값에는 영향을 미치지 않습니다.</p><p><code>numerically</code> 옵션이 <code class="lang-only" data-code-lang="js dart">true</code><code class="lang-only" data-code-lang="python">True</code>인 경우, 문자열로 구성된 배열을 정렬할 때, 이름이 아니라 문자열에 포함된 숫자를 기준으로 먼저 정렬합니다. 이때의 순서는 <a href="/ko/reference/array/sortNumeric">sortNumeric</a>에 적힌 것과 같습니다.</p><h2 id="parameters" tabindex="-1">Parameters <a class="header-anchor" href="#parameters" aria-label="Permalink to &quot;Parameters&quot;">​</a></h2>',4)),n(t,{rows:[{name:"array",type:"any[]",required:!0},{name:"key",type:"string",required:!0},{name:"descending",type:"boolean",default:"false"},{name:"numerically",type:"boolean",default:"false"}]}),s[1]||(s[1]=l("h2",{id:"returns",tabindex:"-1"},[E("Returns "),l("a",{class:"header-anchor",href:"#returns","aria-label":'Permalink to "Returns"'},"​")],-1)),n(p,{type:"any[]"}),s[2]||(s[2]=a(`<h2 id="examples" tabindex="-1">Examples <a class="header-anchor" href="#examples" aria-label="Permalink to &quot;Examples&quot;">​</a></h2><div class="lang-only" data-code-lang="js"><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> obj</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> [</span></span>
