import{_ as h,C as a,o as k,c as d,j as i,a as n,E as t,ag as l}from"./chunks/framework.DGzMGr_a.js";const D=JSON.parse('{"title":"objTo1d","description":"","frontmatter":{},"headers":[],"relativePath":"ko/reference/object/objTo1d.md","filePath":"ko/reference/object/objTo1d.md","lastUpdated":1783923107000}'),r={name:"ko/reference/object/objTo1d.md"},o={id:"objto1d",tabindex:"-1"};function c(E,s,g,y,b,A){const p=a("Lang"),e=a("ParamsTable");return k(),d("div",null,[i("h1",o,[s[0]||(s[0]=n("objTo1d ",-1)),t(p,{dart:"",js:"",python:""}),s[1]||(s[1]=n()),s[2]||(s[2]=i("a",{class:"header-anchor",href:"#objto1d","aria-label":'Permalink to "objTo1d <Lang dart js python />"'},"​",-1))]),s[3]||(s[3]=l('<p>주어진 객체의 객체를 자식 항목의 최상위 레벨로 병합하고, 기존 키 대신 구분 기호(기본적으로 <code>.</code>)를 사용하여 단계별로 키 이름을 표시합니다. 예를 들어, 객체 <code>a</code>에 키 <code>b</code>, <code>c</code>, <code>d</code>가 있는 경우, <code>a</code> 키는 표시되지 않고, 부모 단계에 키와 값 <code>a.b</code>, <code>a.c</code>, <code>a.d</code>가 표시됩니다.</p><h2 id="parameters" tabindex="-1">Parameters <a class="header-anchor" href="#parameters" aria-label="Permalink to &quot;Parameters&quot;">​</a></h2>',2)),t(e,{rows:[{name:"obj",type:"object",required:!0},{name:"separator",type:"string",named:!0,default:"'.'"}]}),s[4]||(s[4]=l(`<h2 id="returns" tabindex="-1">Returns <a class="header-anchor" href="#returns" aria-label="Permalink to &quot;Returns&quot;">​</a></h2><blockquote><p>object</p></blockquote><h2 id="examples" tabindex="-1">Examples <a class="header-anchor" href="#examples" aria-label="Permalink to &quot;Examples&quot;">​</a></h2><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-x4Xdr" id="tab-ENtpKjV" checked><label data-title="JavaScript" for="tab-ENtpKjV">JavaScript</label><input type="radio" name="group-x4Xdr" id="tab-4_HF0MP"><label data-title="Dart" for="tab-4_HF0MP">Dart</label><input type="radio" name="group-x4Xdr" id="tab-YLgakH3"><label data-title="Python" for="tab-YLgakH3">Python</label></div><div class="blocks"><div class="language-javascript vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">objTo1d</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">({</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 	&#39;c&#39;: 3</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># }</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#</span></span></code></pre></div></div></div>`,4))])}const C=h(r,[["render",c]]);export{D as __pageData,C as default};
