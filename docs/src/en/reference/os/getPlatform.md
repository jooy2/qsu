...
<PlatformSupport :rows="[
	...
	{ os: 'android', languages: 'dart', note: '`android`, not `linux`. Android is its own answer because what a program may do there is different.' },
	{ os: 'ios', languages: 'dart', note: '`ios`.' }
]" />
