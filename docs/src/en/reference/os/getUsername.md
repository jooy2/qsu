...
<PlatformSupport :rows="[
	...
	{ os: 'android', languages: 'dart', note: 'The user the app process runs as, which Android names after the app rather than after a person.' },
	{ os: 'ios', languages: 'dart', note: '`mobile`, which every app on the device runs as.' }
]" />
